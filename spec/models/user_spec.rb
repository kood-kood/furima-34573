  ...
  describe 'ユーザー新規登録' do
    ...
    context '新規登録できないとき' do
      ...
      it 'passwordが空では登録できないこと' do
        @user.password = ''
        @user.valid?
        expect(@user.errors.full_messages).to include('パスワードが入力されていません。', 'パスワードが入力されていません。', 'パスワードは有効でありません。',
                                                      '確認用パスワードが内容とあっていません。')
      end
      ...
      it 'last_name_furiganaが空では登録できないこと' do
        ...
        @user.valid?
        expect(@user.errors.full_messages).to include('Last name furiganaが入力されていません。', 'Last name furiganaが入力されていません。',
                                                      'Last name furiganaは有効でありません。')
      end
      it 'given_names_furiganaが空では登録できないこと' do
        @user.given_names_furigana = ''
        @user.valid?
        expect(@user.errors.full_messages).to include('Given names furiganaが入力されていません。', 'Given names furiganaが入力されていません。',
                                                      'Given names furiganaは有効でありません。')
      end
